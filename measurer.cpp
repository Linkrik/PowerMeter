...
Measurer::Measurer()
{
    ...
    DetectorSettings detector_nrp_z24;
    DetectorSettings detector_nrp_z81;
    DetectorSettings detector_nrp_z85;
    DetectorSettings detector_nrp_18t;


///** --------------------------------------- SENSOR NRP-Z85 --------------------------------------- */
    detector_nrp_z85.Mode = MODE_CONTINUE;
    detector_nrp_z85.Channel = 1;
    detector_nrp_z85.IDQuery = true;
    detector_nrp_z85.ResourceName = "USB::0x0AAD::0x0083::*"; /** NRP-Z85 */
    detector_nrp_z85.ResetDevice = true;
    detector_nrp_z85.Session = 1;

    this->Sensor_NRP_Z85 = new Detector(detector_nrp_z85, DEVICE_NRP_Z85);
    this->Sensor_NRP_Z85->SetMode(MODE_CONTINUE);
/** --------------------------------------- SENSOR NRP-18T --------------------------------------- */
    detector_nrp_18t.Mode = MODE_CONTINUE;
    detector_nrp_18t.Channel = 1;
    detector_nrp_18t.IDQuery = true;
    detector_nrp_18t.ResourceName = "USB::0x0AAD::0x0150::*"; /** NRP-18T [S/N 102136]*/
    detector_nrp_18t.ResetDevice = true;
    detector_nrp_18t.Session = 2;

    this->Sensor_NRP_18T = new Detector(detector_nrp_18t, DEVICE_NRP_18T);
    this->Sensor_NRP_18T->SetMode(MODE_CONTINUE);

/** --------------------------------------- SENSOR NRP-Z24 --------------------------------------- */
    detector_nrp_z24.Mode = MODE_CONTINUE;
    detector_nrp_z24.Channel = 1;
    detector_nrp_z24.IDQuery = true;
    detector_nrp_z24.ResourceName = "USB::0x0AAD::0x0015::*"; /** NRP-Z24 */
    detector_nrp_z24.ResetDevice = true;
    detector_nrp_z24.Session = 3;

    this->Sensor_NRP_Z24 = new Detector(detector_nrp_z24, DEVICE_NRP_Z24);
    this->Sensor_NRP_Z24->SetMode(MODE_CONTINUE);

    /** --------------------------------------- SENSOR NRP-Z81 --------------------------------------- */
        detector_nrp_z81.Mode = MODE_CONTINUE;
        detector_nrp_z81.Channel = 1;
        detector_nrp_z81.IDQuery = true;
        detector_nrp_z81.ResourceName = "USB::0x0AAD::0x0023::*"; /** NRP-Z81 [S/N] 104755 */
        detector_nrp_z81.ResetDevice = true;
        detector_nrp_z81.Session = 0;

        this->Sensor_NRP_Z81 = new Detector(detector_nrp_z81, DEVICE_NRP_Z81);
        this->Sensor_NRP_Z81->SetMode(MODE_CONTINUE);
}
