 ...
 *                                niScope                                   *
 *--------------------------------------------------------------------------*
 *   Copyright (c) National Instruments 2004-2020.  All Rights Reserved.    *
 *--------------------------------------------------------------------------*
 *                                                                          *
 * Title:    niScope.h                                                      *
 * Purpose:  niScope                                                        *
 ...
 ****************************************************************************/
#define NISCOPE_MAJOR_VERSION                                                  19                                                            // Instrument driver major version
#define NISCOPE_MINOR_VERSION                                                  600                                                           // Instrument driver minor version
